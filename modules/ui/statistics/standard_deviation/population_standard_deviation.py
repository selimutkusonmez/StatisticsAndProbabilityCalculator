...
class OperationWidget(QWidget):
    ...
    def init_ui(self):
        ...
        self.variable_1_info = QTextEdit("<b>&sigma; (Population Standard Deviation):</b><br>"
                                        "It is the square root of the population variance. It represents the average distance "
                                        "between each data point and the population mean in the original units of the data.")
        ...
        self.variable_2_info = QTextEdit("<b>&mu; (Population Mean):</b> The average value of all observations in the entire population.")
                        ...
                        <table cellpadding="0" cellspacing="0">
                            <tr>
                                <td align="center" style="border-bottom: 2px solid currentColor; padding: 0px 8px;">
                                    &radic;&Sigma;(x<sub>i</sub> - {self.variable_1})<sup>2</sup>
                                </td>
                            </tr>
                            <tr>
    ...
    def calculate_button_function(self):
        try:
                result = math.sqrt(sum((x - (sum(self.data) / self.variable_2)) ** 2 for x in self.data)/self.variable_2)
