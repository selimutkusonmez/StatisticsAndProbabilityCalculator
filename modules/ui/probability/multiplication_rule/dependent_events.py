...
class OperationWidget(QWidget):
    ...
    def init_ui(self):
        ...
        self.variable_1_info = QTextEdit("<b>P(A &cap; B) (Intersection for Dependent Events):</b><br>"
                                        "The probability that <b>both</b> Event A and Event B occur together when they are dependent "
                                        "(meaning the outcome of Event A affects Event B).")
        ...
        self.variable_3_info_label = QLabel("P(B|A)")
        self.right_group_box_layout.addWidget(self.variable_3_info_label,2,0)

        self.variable_3_info = QTextEdit("<b>P(B|A) (Conditional Probability):</b><br>"
                                        "The probability that Event B occurs, <b>given that</b> Event A has already occurred.<br><br>")
