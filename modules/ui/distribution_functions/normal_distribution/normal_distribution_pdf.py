...
class OperationWidget(QWidget):
    ...
    def init_ui(self):
        ...
        self.variable_1_info = QTextEdit("<b>Normal Distribution:</b><br>"
                                        "A continuous probability distribution characterized by a symmetric, bell-shaped curve. "
                                        "Most of the observations cluster around the central peak (mean), and the probabilities for values further away from the mean taper off equally in both directions.<br>"
                                        "<i>Note: For continuous distributions, the probability of an exact value P(X = x) is zero. We use the PDF to find the density (height of the curve) or the CDF to find the probability over an area.</i>")
                        ...
                        <table cellpadding="0" cellspacing="0" style="font-size: 36px;">
                            ...
                            <tr>
                                <td align="center" style="padding: 6px 12px 0px 12px;">
                                    {self.variable_2_display}&radic;<span style="text-decoration: overline;">2&pi;</span>
                                </td>
                            </tr>
                        </table>
                    </td>
                    ...
                    <td valign="top" style="padding-top: 8px;"> <table cellpadding="0" cellspacing="0" style="font-size: 27px;">
                            <tr>
                                ...
                                <td align="center" style="border-bottom: 2px solid currentColor; padding: 0px 6px 3px 6px;">
                                    ({self.variable_4_display} &minus; {self.variable_1_display})<sup>2</sup>
                                </td>
                            </tr>
                            <tr>
