...
class OperationWidget(QWidget):
    ...
    def init_ui(self):
        ...
        self.variable_1_input.setPlaceholderText("Average Rate")
        ...
        self.variable_2_input.setPlaceholderText("Target Number of Events")
        ...
        self.variable_1_info = QTextEdit("<b>Poisson Distribution (PMF):</b><br>"
                                        "A discrete probability distribution that calculates the probability of <b>exactly <i>x</i> independent events</b> "
                                        "occurring within a fixed interval of time or space.<br>"
                                        "<i>(e.g., Finding the probability of receiving EXACTLY 4 phone calls in the next hour, given that the historical average is 2.5 calls per hour.)</i>")
        ...
        self.variable_3_info = QTextEdit("<b>x (Target Number of Events):</b><br>"
                                        "The exact number of occurrences you want to find the probability for. "
                                        "This must be a whole number (<b>x &ge; 0</b>).")
    ...
    def update_formula_display(self):
        ...
        try:
            ...
            self.variable_2_display = "x"

        html_formul = f"""
            <table align="center" cellpadding="0" cellspacing="0" style="font-size: 55px; font-family: 'Times New Roman', serif;">
                <tr>
    ...
    def calculate_button_function(self):
        try:
            ...
            result = (self.variable_1 ** self.variable_2) * (math.e ** (self.variable_1 * -1))/(math.factorial(self.variable_2))
